    ...
    237: function(t, i, a) {
        ...
        (function(t) {
            ...
            i.a = {
                middleware: "interad",
                components: {
                    Comments: a(262).default,
                    "htv-ad": a(188).default,
                    "htv-lazy": a(183).default,
                    "htv-native-ad": a(263).default,
                    "htv-native-ad-1": a(264).default,
                    "htv-video-player": a(265).default,
                    "hentai-video-card-horizontal-menu": a(196).default,
                    "htv-playlist-panel": a(266).default,
                    "htv-video-page-action-bar": a(267).default,
                    "htv-video-page-info": a(268).default,
                    "htv-video-page-related": a(269).default,
                    "htv-video-page-tags-summary": a(270).default
                },
                fetch: function(e) {
                    return o()(regeneratorRuntime.mark((function t() {
                        ...
                        return regeneratorRuntime.wrap((function(t) {
                            for (; ; )
                                ...
                                case 3:
                                    return a = [],
                                    e.route.query.playlist_id && a.push("playlist_id=".concat(e.route.query.playlist_id)),
                                    n = !1,
                                    t.prev = 6,
                                    t.next = 9,
                                    S.doFetch("".concat(hw_api_base_url, "/api/v8/video?id=").concat(i, "&").concat(a.join("&")), "video", e);
                                case 9:
                                    t.next = 16;
                                    break;
                                case 11:
                                ...
                                case 18:
                                    S.page_name = "Now Playing",
                                    S.is_dev ? S.data.video.host = "http://localhost:2000" : (o = e.req ? e.req.headers.host : window.location.host,
                                    S.data.video.host = "https://".concat(o));
                                case 20:
                                case "end":
                                    return t.stop()
                                }
                    ...
                    return o()(regeneratorRuntime.mark((function t() {
                        return regeneratorRuntime.wrap((function(t) {
                            for (; ; )
                                switch (t.prev = t.next) {
                                case 0:
                                    if (Events.$on(Events.TOGGLE_SHUFFLE, e.toggleShuffle),
                                    Events.$on("PLAY_NEXT_VIDEO", e.goToNextVideo),
                                    S.browser_width >= 960 && e.$nextTick((function() {
                ...
                beforeDestroy: function() {
                    Events.$off(Events.TOGGLE_SHUFFLE, this.toggleShuffle),
                    Events.$off("PLAY_NEXT_VIDEO", this.goToNextVideo)
                },
                methods: {
                    getHead: function() {
                        return {
                    ...
                    toggleShuffle: function() {
                        S.shuffle = !S.shuffle,
                        S.shuffle ? Events.$emit(Events.SNACK, "Shuffle is on") : Events.$emit(Events.SNACK, "Shuffle is off")
                    },
                    goToNextVideo: function() {
                        if (this.pg.next_hentai_video) {
                            ...
                            S.shuffle && (t = this.pg.next_random_hentai_video.slug),
                            Events.$emit(Events.GOTO, "/videos/hentai/".concat(t).concat(e))
                        }
                    },
